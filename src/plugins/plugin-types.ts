/**
 * Internal copy of plugin types for the main app's TypeScript compilation.
 * The canonical source for external developers is @intraclaw/sdk (packages/plugin-sdk/).
 * These are intentionally kept in sync but compiled separately.
 */
